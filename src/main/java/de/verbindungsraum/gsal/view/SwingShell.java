 ...
 * de.verbindungsraum.gsal.view.SwingShell.java 1.0 | 2013.09.14 bas | UTF8 | tab 2
 */
...
public class SwingShell
{
  ...
  void showGUI()
  {
    ...
    loginFrame  = new JFrame("GSAL - Shell");
  ...
  class EnterSomethingDialog extends JDialog
  {
    ...
    public EnterSomethingDialog(JFrame parent, String title, String[] content, boolean isPassword)
    {
      ...
      if(isPassword) pan.add(passwordField);
      else pan.add(answerField);
    ...
    private void finish()
    {
      if(isPassword) answer = new String(passwordField.getPassword());
      else answer = answerField.getText();
